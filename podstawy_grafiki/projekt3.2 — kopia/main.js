...
///////////////////////////////////////////////////////////////////////
const grass_txt = new THREE.TextureLoader().load('public/grass.png' ); 
const bark_txt = new THREE.TextureLoader().load('public/bark.png' ); 
const leaves_txt = new THREE.TextureLoader().load('public/leaves.png' );
const road_txt = new THREE.TextureLoader().load('public/road.png' );  
const pavement_txt = new THREE.TextureLoader().load('public/pavement.png' ); 
const glass_txt = new THREE.TextureLoader().load('public/glass.png' ); 
pavement_txt.wrapS = THREE.RepeatWrapping;
pavement_txt.wrapT = THREE.RepeatWrapping;
pavement_txt.repeat.set( 8, 4 ); 
const bricks_txt = new THREE.TextureLoader().load('public/bricks.png' ); 
bricks_txt.wrapS = THREE.RepeatWrapping;
bricks_txt.wrapT = THREE.RepeatWrapping;
bricks_txt.repeat.set( 2, 10 ); 
///////////////////////////////////////////////////////////////////////
//MATERIALS
THREE.TextureLoader
const grass_material = new THREE.MeshStandardMaterial({ color: 0x6a994e, map:grass_txt })
const pavement_material = new THREE.MeshStandardMaterial({ color: 0x1f1f2e, map:road_txt })
const pavement_material2 = new THREE.MeshStandardMaterial({ color: 0x535379, map:pavement_txt })
const line_material = new THREE.MeshStandardMaterial({ color: 0xffffff, map:road_txt  })

const log_material = new THREE.MeshStandardMaterial({ color: 0x582f0e, map: bark_txt});
const tree_material = new THREE.MeshStandardMaterial({ color: 0x386641, map: leaves_txt });
...
const building_material = new THREE.MeshStandardMaterial({ color: 0xfcefb4, map:bricks_txt});
const sep_material = new THREE.MeshStandardMaterial({ color: 0xf9dc5c, map:bricks_txt });

const building_material2 = new THREE.MeshStandardMaterial({ color: 0xdddddd, map:bricks_txt });
const sep_material2 = new THREE.MeshStandardMaterial({ color: 0xbbbbbb, map:bricks_txt });
///////////////////////////////////////////////////////////////////////
function floor() {
